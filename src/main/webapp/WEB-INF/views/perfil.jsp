...
.forgot-password:focus{
 ...
 <div class="card card-container">
            ...
            <p style="align-content: center; margin:auto; display:table; font-size: 20px; color:grey;">Perfil</p>
                ...
                <form action="modificarPerfil" method="get">
                <button id="btnModificarPerfil" class="btn btn-lg btn-primary btn-block btn-signin" value="ModificarPerfil" name="modificarPerfil" type="submit">Modificar Perfil</button>
            	</form>
            <div>
        	</div>
        </div><!-- /card-container -->
