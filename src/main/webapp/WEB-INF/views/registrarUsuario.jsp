...
<body>
	...
	<div id="contenedor"
		...
		<div class="container">
			<h1 style="color: white">Registra un usuario en Intravita</h1>
			<p style="font-size: 20px; color: white">Introduce sus datos
			...
			<div class="card card-container">
				...
				<form action="registrarUsuarioViaAdmin" method="post" class="form-signin"
					name="form1">
