...
public class RegisterUsuarioController {
	private static final Logger logger = LoggerFactory
			.getLogger(RegisterUsuarioController.class);
	...
	@RequestMapping(value = "registrarUsuarioViaAdmin", method = RequestMethod.POST)
	public ModelAndView registrar(HttpServletRequest request,
		...
		ModelAndView miMAV = new ModelAndView("registrarUsuario");
